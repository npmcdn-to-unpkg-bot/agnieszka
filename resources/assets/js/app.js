...
$(window).on('load', function() {
  ...
  var pageloadTween = new TimelineMax()
        .staggerTo([body,topNavBar,sidebar], 0.60,{opacity:1,ease:ease2}, 0.20)
        .to(topNavBar,0.2,{y:0,ease:ease2},"-=0.40")
        .staggerTo(topNavLinks,0.8,{y:0,opacity:1,ease:ease2}, 0.15,"-=1.2")
        .to(page,0.2,{opacity:1,ease:Power3.easeInOut})
        .staggerTo(pageElements,1,{y:0,ease:Power3.easeInOut},0.20,"-=0.25");
